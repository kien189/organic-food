...
<head>
    ...
    <!-- Linear Icon css -->
    <link rel="stylesheet" href="{{ asset('server/assets') }}/css/linearicon.css">

    <!-- fontawesome css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('server/assets') }}/css/vendors/font-awesome.css">

    <!-- Themify icon css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('server/assets') }}/css/vendors/themify.css">

    <!-- ratio css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('server/assets') }}/css/ratio.css">

    <!-- remixicon css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('server/assets') }}/css/remixicon.css">
    ...
    <!-- vector map css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('server/assets') }}/css/vector-map.css">

    <!-- Slick Slider Css -->
    <link rel="stylesheet" href="{{ asset('server/assets') }}/css/vendors/slick.css">
...
<body>
            ...
            <div class="header-wrapper m-0">
                <div class="header-logo-wrapper p-0">
                    ...
                    <div class="toggle-sidebar">
                        ...
                        <a href="index.html">
                            <img src="{{ asset('server/assets') }}/images/logo/1.png" class="img-fluid" alt="">
                        </a>
                    </div>
                </div>
    ...
    <!-- latest js -->
    <script src="{{ asset('server/assets') }}/js/jquery-3.6.0.min.js"></script>
    ...
    <!-- Apexchar js -->
    <script src="{{ asset('server/assets') }}/js/chart/apex-chart/apex-chart1.js"></script>
    <script src="{{ asset('server/assets') }}/js/chart/apex-chart/moment.min.js"></script>
    ...
    <script src="{{ asset('server/assets') }}/js/chart/apex-chart/chart-custom1.js"></script>


    <!-- slick slider js -->
    <script src="{{ asset('server/assets') }}/js/slick.min.js"></script>
    <script src="{{ asset('server/assets') }}/js/custom-slick.js"></script>

    <!-- customizer js -->
    <script src="{{ asset('server/assets') }}/js/customizer.js"></script>

    <!-- ratio js -->
    <script src="{{ asset('server/assets') }}/js/ratio.js"></script>

    <!-- sidebar effect -->
    <script src="{{ asset('server/assets') }}/js/sidebareffect.js"></script>
