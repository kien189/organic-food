...
<body>
    ...
    <div class="container">
      <div class="header__wrapper">
        ...
        <div class="header__action">
          <a class="header__action-btn d-none d-xl-grid" href="{{ route('login') }}"><i class="fa-regular fa-user"></i></a>
          ...
          <div class="trk-search">
            <div class="trk-search__inner">
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Search Here" aria-label="trk Search Bar"
  ...
  <footer class="footer ">
          ...
          <div class="row gy-5 gx-2">
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="footer__about">
                <a href="/" class="footer__about-logo"><img src="{{ asset('client/assets') }}/images/logo/logo-dark.svg"
                    alt="Logo"></a>
            ...
            <div class="col-xl-2 col-md-3 col-sm-6 col-6">
              <div class="footer__links">
                ...
                <div class="footer__links-content">
                  <ul class="footer__linklist">
                    <li class="footer__linklist-item"> <a href="{{ route('login') }}">Sign In</a>
                    </li>
          ...
          <div class="footer__bottom-payment">
            <ul class="payment">
              <li class="payment__item">
                <img src="{{ asset('client/assets') }}/images/payment/1.png" alt="payment method logo">
              </li>
              <li class="payment__item">
                <img src="{{ asset('client/assets') }}/images/payment/2.png" alt="payment method logo">
              </li>
              <li class="payment__item">
                <img src="{{ asset('client/assets') }}/images/payment/3.png" alt="payment method logo">
              </li>
              <li class="payment__item">
                <img src="{{ asset('client/assets') }}/images/payment/4.png" alt="payment method logo">
              </li>
              <li class="payment__item">
                <img src="{{ asset('client/assets') }}/images/payment/5.png" alt="payment method logo">
              </li>
            </ul>
          </div>
          <div class="footer__bottom-copyright">
            <p class=" mb-0">Copyright© 2024 <a href="https://themeforest.net/user/thetork" target="_blank">thetork</a>.
    ...
    <div class="footer__shape">
      <span class="footer__shape-item footer__shape-item--1"><img src="{{ asset('client/assets') }}/images/banner/home1/leaf.png"
          alt="shape icon"></span>

      <span class="footer__shape-item footer__shape-item--2"><img src="{{ asset('client/assets') }}/images/banner/home1/tomato.png"
          alt="shape icon"></span>

      <span class="footer__shape-item footer__shape-item--3"><img src="{{ asset('client/assets') }}/images/banner/home1/chilli.png"
          alt="shape icon"></span>
    </div>
  </footer>
  <!-- ===============>> footer end here <<================= -->
