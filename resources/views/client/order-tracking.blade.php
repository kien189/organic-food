...
@section('content')
  ...
  <section class="account padding-top padding-bottom">
    <div class="container">
      <div class="account__wrapper" data-aos="fade-up" data-aos-duration="1000">
          ...
          <div class="col-lg-6">
            <div class="account__content account__content--style1">
              ...
              <div class="account__header">
                ...
                <p>Stay in the loop with real-time updates. Easily monitor and 'Track Your Order' for a stress-free
              ...
              <form action="#" class="account__form needs-validation" novalidate>
                <div class="row g-4">
                  <div class="col-12">
                    <div>
                      <label for="account-email" class="form-label">Order ID</label>
                ...
                <button type="submit" class="trk-btn trk-btn--border trk-btn--primary d-block mt-4">Track your
                  order</button>
              </form>
            </div>
          </div>
